...
page = st.sidebar.radio("Go to", ["Cleaning Data","Visualizing Data"])
...
if page == "Cleaning Data":
    ...
    # Find columns with more than 50% missing values and ask if they want to delete. If they do want to delete, delete them. If they don't want to delete, store them in a separate dataframe.

            # Set threshold and find missing by column
